       ...
       1000-INITIALIZE.
           ...
           OPEN INPUT MASTER-FILE
                ...
                OUTPUT REPORT-FILE.
           PERFORM 1100-NEW-PAGE.
           PERFORM 1200-READ-MASTER.
           PERFORM 1300-READ-TRAN.
       ...
       2100-APPLY-TRANSACTIONS.
           IF WS-EOF-TRAN = "Y"
               GO TO 2200-NO-MORE-TRANS
           END-IF.

           IF T-ACCT-NO NOT = WS-CURRENT-ACCT
               IF T-ACCT-NO < WS-CURRENT-ACCT
                   PERFORM 1300-READ-TRAN
                   GO TO 2100-APPLY-TRANSACTIONS
               ELSE
                   GO TO 2200-NO-MORE-TRANS
               END-IF
           END-IF.
      ...
      *    NOTE: BALANCE NOT CONVERTED TO DISPLAY PROPERLY, LEGACY FORMAT
       ...
       3000-PRINT-DETAIL.
           ...
           MOVE WS-DAILY-TRANS         TO PL-TRAN-AMT.
           MOVE WS-MSG                 TO PL-MSG.

           MOVE WS-PRINT-LN            TO REPORT-REC.
           WRITE REPORT-REC.

           IF WS-PAGE-NO > 0
               IF WS-DAILY-COUNT > 20
                   MOVE 0 TO WS-DAILY-COUNT
                   PERFORM 1100-NEW-PAGE
               END-IF
           END-IF.
       ...
       9000-FINALIZE.
           MOVE "***** RUN SUMMARY *****" TO REPORT-REC(1:23).
           WRITE REPORT-REC.
